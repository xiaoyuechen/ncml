...
\abstract{
In this report we developed a genetic algorithm-based solver. The algorithm combined crossover from genetic algorithm and local search from WalkSAT 
}
\newline
\newline
{\bf Keywords:} genetic algorithm, SAT, NP hard problem
